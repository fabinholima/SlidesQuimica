...
\label{sec:org6d24bc8}
\begin{frame}[label={sec:orgb55b9a3}]{Hidrocarbonetos}
\begin{tikzpicture}
...
\begin{frame}[label={sec:org469369f}]{Hidrocarbonetos}
\begin{itemize}
...
\caption{\label{fig:orgdaff712}Esquema de uma torre de fracionamento.}
\end{figure}
\end{frame}

\begin{frame}[label={sec:org8cdbb05}]{Frações Típicas do Petróleo}
%		{\centering \small
			\begin{talltblr}[
				theme= fancy,
...
\label{sec:org7c11bdb}

\begin{frame}[label={sec:orge82f39f}]{Grupos}
\begin{itemize}
...
\begin{frame}[label={sec:org2985bd8}]{Nomenclatura dos compostos orgânicos}
\begin{itemize}
...
\begin{frame}[label={sec:orge546c53}]{Nomenclatura dos compostos orgânicos}
\begin{itemize}
...
\begin{frame}[label={sec:orga7e2930}]{Nomenclatura dos compostos orgânicos}
\begin{itemize}
...
\begin{frame}[label={sec:org1c4e359}]{Fim da Aula}
\begin{tikzpicture}
