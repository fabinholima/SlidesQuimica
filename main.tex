...
\label{sec:orgc655e16}

\begin{frame}[label={sec:orga82d282}]{Hidrocarbonetos Ramificados}
...
\section{Nomeclatura}
\label{sec:org69808fc}

\begin{frame}[label={sec:orga25c3a2}]{Nomenclatura}
\begin{myrule}{Regras}
...
\label{sec:org1b4f4d1}

\begin{frame}[label={sec:orgbea15c1}]{Hidrocarbonetos cadeia mista}
\begin{itemize}
...
\begin{frame}[label={sec:org66c0670}]{Hidrocarbonetos cadeia mista}
\begin{itemize}
...
\begin{frame}[label={sec:orgada3b3d}]{}
\begin{itemize}
...
\begin{frame}[label={sec:org7e058a6}]{}
\begin{itemize}
...
\begin{frame}[label={sec:org41fb849}]{Cadeia Mista - Nomenclatura trivial}
\begin{itemize}
...
\begin{frame}[label={sec:org46a9f1c}]{Cadeis Mistas - Outros exemplos}
...
\begin{frame}[label={sec:orgb548e01}]{Fim da Aula}
\begin{tikzpicture}
