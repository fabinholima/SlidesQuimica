...
\begin{frame}[label={sec:orgb45888c}]{Pósitron (\(\upbeta^+\))}
\begin{columns}
\begin{column}{0.45\columnwidth}
...
\begin{frame}[label={sec:org51c141a}]{Radiação Gama}
\small{
...
\begin{frame}[label={sec:org2f17d72}]{Poder de penetração da radiação}
...
\caption{\label{fig:orgda4f2e1}Poder de penetração das radiações.}
\end{figure}
\end{frame}
...
\caption{\label{fig:org238a297}Decaimento do  \isotope{131,I}  pela sua meia-vida física de 8 dias.}
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}[label={sec:org67c2235}]{Radiação Gamma}
\begin{center}
...
\label{sec:orge5c06b5}
\begin{frame}[label={sec:org43efe76}]{Fissão Nuclear}
...
\label{sec:org56101f0}
\begin{frame}[label={sec:org2efcde7}]{Fusão Nuclear}
...
\section{Aplicação}
\label{sec:org2c3c8df}
\begin{frame}[label={sec:org7afe346}]{Radioterapia}
