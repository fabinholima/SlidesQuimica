...
\label{sec:orgef15bbe}
\begin{frame}[label={sec:orge0d104f}]{Hidrocarbonetos}
...
\begin{frame}[label={sec:org03905ab}]{Hidrocarbonetos}
\begin{itemize}
...
\caption{\label{fig:org6c15b30}Esquema de uma torre de fracionamento.}
\end{figure}
\end{frame}

\begin{frame}[label={sec:org18bcf8c}]{Frações Típicas do Petróleo}
%		{\centering \small
			\begin{talltblr}[
				theme= fancy,
...
\label{sec:orgd3b4016}

\begin{frame}[label={sec:orge7843ab}]{Grupos}
\begin{itemize}
...
\begin{frame}[label={sec:org4f350b2}]{Nomenclatura dos compostos orgânicos}
\begin{itemize}
...
\begin{frame}[label={sec:org0668742}]{Nomenclatura dos compostos orgânicos}
\begin{itemize}
...
\begin{frame}[label={sec:org394c198}]{Nomenclatura dos compostos orgânicos}
\begin{itemize}
...
\begin{frame}[label={sec:org3cd09fc}]{Fim da Aula}
\begin{tikzpicture}
