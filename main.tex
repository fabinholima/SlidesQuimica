...
\label{sec:org8cfe2cc}
\begin{frame}[label={sec:org08eae73}]{Hidrocarbonetos}
\begin{tikzpicture}
...
\begin{frame}[label={sec:org649e204}]{Hidrocarbonetos}
\begin{itemize}
...
\caption{\label{fig:orgf2d9565}Esquema de uma torre de fracionamento.}
\end{figure}
\end{frame}

\begin{frame}[label={sec:org8b7a4e9}]{Frações Típicas do Petróleo}
%		{\centering \small
			\begin{talltblr}[
				theme= fancy,
...
\label{sec:org2f33f5f}

\begin{frame}[label={sec:org7d2eaf2}]{Grupos}
\begin{itemize}
...
\begin{frame}[label={sec:orgeb0563a}]{Nomenclatura dos compostos orgânicos}
\begin{itemize}
...
\begin{frame}[label={sec:org009e952}]{Nomenclatura dos compostos orgânicos}
\begin{itemize}
...
\begin{frame}[label={sec:org78477cb}]{Nomenclatura dos compostos orgânicos}
\begin{itemize}
...
\begin{frame}[label={sec:org33a548a}]{Fim da Aula}
\begin{tikzpicture}
