...
\usepackage[skins,most,many]{tcolorbox}
\usepackage{endiagram}
\tcbuselibrary{skins,raster,listings,breakable,vignette}
...
colback=white!40,colframe=black,fonttitle=\bfseries,sharp corners,
title=Exemplo~\thetcbcounter~#1}
\newcounter{mycounter}
%%% Colobor
%%% Example colorbox
...
%% COnfig tikz molecules
\usepackage{supertabular}
\tikzset{
bal/.style={
circle, minimum size=2pt, inner sep=0pt,fill=orange,fill opacity=0.5
},
rect/.style={
circle, minimum size=2pt, inner sep=.5pt,fill=red,fill opacity=0.5
},
bal2/.style={
circle, minimum size=2pt, inner sep=0pt,fill=blue,fill opacity=0.5
},
bal3/.style={
circle, minimum size=2pt, inner sep=0pt,fill=yellow,fill opacity=0.5
}
}
\definesubmol\nobond{-[,0.2,,,draw=none]\scriptstyle\color{blue}}
\newcommand{\re}{\hspace{-1cm}}
\newcommand{\af}{\hspace{2cm}}
\graphicspath{{img}{QG/img}{FQ/img}}
...
\label{sec:orgfd05147}

\begin{frame}[label={sec:org5928939}]{Hidrocarbonetos Ramificados}
...
\section{Nomeclatura}
\label{sec:org6d61e33}

\begin{frame}[label={sec:org9e64f4a}]{Nomenclatura}
\begin{myrule}{Regras}
...
\label{sec:orgb590e13}

\begin{frame}[label={sec:org84a1115}]{Hidrocarbonetos cadeia mista}
\begin{itemize}
...
\begin{frame}[label={sec:org26fe10d}]{Hidrocarbonetos cadeia mista}
\begin{itemize}
...
\begin{frame}[label={sec:org8968963}]{}
\begin{itemize}
...
\begin{frame}[label={sec:org8bba77d}]{}
\begin{itemize}
...
\begin{frame}[label={sec:orgbc633db}]{Cadeia Mista - Nomenclatura trivial}
\begin{itemize}
...
\begin{frame}[label={sec:org880b84d}]{Cadeis Mistas - Outros exemplos}
...
\begin{frame}[label={sec:orgcb708db}]{Fim da Aula}
\begin{tikzpicture}
