...
\begin{bclogo}[couleur=blue!30 , arrondi=0.1 , logo=\bcplume , epBarre=3.5]{Alquilação e Acilação de Friedel-Crafts}
...
\begin{block}{Diregência de Substituição-\emph{Orto}}
\begin{bclogo}[couleur=blue!30 , arrondi=0.1 , logo=\bcplume , epBarre=3.5]{Orto diregente}
...
\begin{block}{Diregência de Substituição-\emph{Meta}}
\tiny
...
\begin{block}{}
\begin{bclogo}[couleur=blue!30 , arrondi=0.1 , logo=\bcplume , epBarre=3.5]{Meta diregente}
...
\chemfig{C{\ell}_2} 
\arrow(c1.mid east--c2.mid west){->} 
\chemname{\chemfig{*6(-=(-Cl)-=(-C([:40]-H)([:140]=O))-=)}}{\textit{meta}} \+{1em} HC{\ell}
\schemestop
\chemmove{
\node[align=center,text width=1.5cm,minimum width=1cm,draw=none,above= .5cm of c1,font=\normalfont](text1){Grupo \textit{meta} diregente};
}
