...
#+LATEX_HEADER:		\SetTblrStyle{caption-tag}{font=\bfseries}
#+LATEX_HEADER:		\SetTblrInner[tblr,longtblr]{rowsep=2.5pt}
#+LATEX_HEADER:		\DefTblrTemplate{firsthead, middlehead,lasthead}{default}{} % <---
#+LATEX_HEADER:		\DefTblrTemplate{contfoot-text}{normal}{\scriptsize\textit{Continued on the next page}}
#+LATEX_HEADER:		\SetTblrTemplate{contfoot-text}{normal}
#+LATEX_HEADER:	}
	
#+LATEX_HEADER:	\selectlanguage{portuguese}
#+LATEX_HEADER:	%\UseTblrTemplate{caption-tag}{default}{\bfseries}


#+LATEX_HEADER: %% == CUSTOM TEAMPLEATE FOR XSIM == %%  
...
#+LATEX_HEADER:	solution-name = Sol. ,
